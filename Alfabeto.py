...
codigos0 = ['nR4oPq2Su9', 'I3aSbVxKd5', 'w1mPjYqZ30', 'H8aXoBc2Nk', '7bMqF5pL3s', 'uW2cJlVAe4', '5fRnZpU18h',
...
codigos1 = ['mPw6dA1vBz', 'S3rYjKbV9T', '7aPqZlXcN8', 'I2fUoHsR0G', 'aE4nWxL5uJ', 'bCtQm7gF1i', '9oRk3pDlYh',
...
codigos2 = ['oZ4xR2mEhD', 'I8uKwN9vPc', '5lQsGfU6kT', 'H3eCqP0yMv', 'rV7bFgJdA2', 'uXtWmS5zLq', 'nYp4wU9kHj',
...
codigos3 = ['qJkH8yPmL1', 'I7fCvN5jZt', 'oXbE4sNwF6', 'rA2jM5gWuQ', '3nFyGtB6dH', '7wTlQo8iVc', 'U1eKsW4hYj',
...
codigos4 = ['qF3wK6lBvG', '8dUcWbJ1hV', 'rP5eXoZjIa', '7fHqN2mRdW', 'lEiJ1oF3cK', 'tQpV4gX9yM', 'dS6nA8vYzR',
...
codigos5 = ['jN1rL4xVfH', 'KmU9gE2sVl', 'aDqG5kXpC8', 'oW3lJtS9rN', '7hFyBpRjKd', 'TbA5dVnF3i', 'gQ6vYmZ2sW',
...
codigos6 = ['wV3sJbN9dU', 'cR8xPqTmLk', 'jN4gWqK6hX', 'yA1jE8zSfB', '9fD7wVbZiG', 'lH6qVtWjCm', 'sG3fJ8vMhT',
...
codigos7 = ['qW5vA8tYkN', 'L6mJpI2rQo', 'V9wXnU5rZa', 'cE8uQlM6yS', 'G2tB7vYnCf', '9eVbJmW7sT', 'oD3jH4lQsX',
...
codigos8 = ['eS1mB8yZlT', 'N4gHkW3sJb', '8jPmDlXnW7', 'aE5dL7vYnF', 'K4cR3bAqUz', '2hYrCfQ8vA', 'W7tM9sH5kR',
...
codigos9 = ['oP3nBf5gJl', 'T9mCzAqW7s', 'rL2yXwG6hV', 'kU8jDc4vNt', '5iSxR7zFpQ', 'qE1bHdY6mT', 'J4vNfP2aRg',
...
todosOsAlfabetos = [alfabeto0, alfabeto1, alfabeto2, alfabeto3, alfabeto4, alfabeto5, alfabeto6, alfabeto7, alfabeto8,
                    alfabeto9]
todosOsCodigos = [codigos0, codigos1, codigos2, codigos3, codigos4, codigos5, codigos6, codigos7, codigos8, codigos9]
...
def Alfabeto():
    ...
    #print(f'Alfabeto: {alfabetoEscolhido}')

    return alfabetoEscolhido

def Codigo():
    global numeroAlfabetoEscolhido
    grupoDeCodigosEscolhido = todosOsCodigos[numeroAlfabetoEscolhido]
    numeroCodigoEscolhido = random.randint(0, 9)
    codigoEscolhido = grupoDeCodigosEscolhido[numeroCodigoEscolhido]
